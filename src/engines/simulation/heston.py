...
def simulate_heston_paths(S0: float, v0: float, kappa: float, theta: float, sigma_v: float, rho: float, r: float, T: float, n_steps: int, n_paths: int, seed: SeedLike = None, antithetic: bool = False) -> tuple:
    """
